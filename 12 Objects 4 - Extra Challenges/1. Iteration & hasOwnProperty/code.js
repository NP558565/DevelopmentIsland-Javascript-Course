...
//add a method returnProperties to the phone prototype which returns the list of own properties (no methods), 
//of an instance as a list of two Arrays: one Array for properties and one Array for values.
